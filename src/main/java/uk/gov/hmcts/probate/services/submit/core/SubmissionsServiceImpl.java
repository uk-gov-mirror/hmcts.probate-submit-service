...
public class SubmissionsServiceImpl implements SubmissionsService {
    ...
    @Override
    public CaseResponse submit(String applicantEmail, CaseRequest caseRequest) {
        SecurityDTO securityDTO = securityUtils.getSecurityDTO();
        CaseData caseData = caseRequest.getCaseData();
        CaseResponse caseResponse = findCase(applicantEmail, CaseType.getCaseType(caseData), securityDTO);
