...
@Slf4j
@Component
public class UpdateCaseToDraftSubmissionService extends AbstractSubmissionsService {

    private final CoreCaseDataService coreCaseDataService;
    private final EventFactory eventFactory;

    @Autowired
    public UpdateCaseToDraftSubmissionService(CoreCaseDataService coreCaseDataService, EventFactory eventFactory, SecurityUtils securityUtils, SearchFieldFactory searchFieldFactory, CaseDataValidatorFactory caseDataValidatorFactory) {
