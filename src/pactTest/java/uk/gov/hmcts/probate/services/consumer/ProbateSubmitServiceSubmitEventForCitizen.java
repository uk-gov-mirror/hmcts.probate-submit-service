...
import static uk.gov.hmcts.reform.probate.pact.dsl.PactDslBuilderForCaseDetailsList.*;

import uk.gov.hmcts.probate.services.util.PactDslFixtureHelper;
...
public class ProbateSubmitServiceSubmitEventForCitizen extends AbstractProbateSubmitServicePact {
    ...
    @Pact(provider = "ccd", consumer = "probate_probateSubmitService")
