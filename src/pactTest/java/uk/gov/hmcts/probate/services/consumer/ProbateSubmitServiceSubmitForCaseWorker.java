...
import static uk.gov.hmcts.probate.services.util.ObjectMapperTestUtil.convertObjectToJsonString;
import static uk.gov.hmcts.probate.services.util.PactDslFixtureHelper.getCaseDataContent;
...
public class ProbateSubmitServiceSubmitForCaseWorker {
  ...
  public void verifySubmitForCaseworker() throws Exception {
   ...
   // assertThat(startEventResponse.getToken(), CoreMatchers.is("testServiceToken"));
    ...
    //TODO
    assertThat(caseDetails.getJurisdiction(), is("DIVORCE")); // TODO CHANGE THIS IN THE PACT COMMONS AND ASSERT
    assertThat(caseDetails.getCaseTypeId(), is("CaseCreated"));// TODO CHANGE THIS IN THE PACT COMMONS AND ASSERT
