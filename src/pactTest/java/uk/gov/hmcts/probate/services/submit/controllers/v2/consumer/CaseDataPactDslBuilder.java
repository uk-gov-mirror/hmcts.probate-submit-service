                    ...
                    .object("data", (cd) -> {
                                cd.stringValue("type", CaseType.GRANT_OF_REPRESENTATION.getName())
                                        ...
                                        .object("legalStatement", (legalStatement) ->
                                                legalStatement.stringType("applicant", "We, Jon Snow of ssssssssssssssssssssssssssssssssssssssss and Jon Snow of xxxxxxxxxxxxxxxxxxxxxxxxxxx, make the following statement:")
