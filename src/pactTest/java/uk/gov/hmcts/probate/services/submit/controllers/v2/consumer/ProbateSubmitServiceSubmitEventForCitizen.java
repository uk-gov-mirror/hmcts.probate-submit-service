...
public class ProbateSubmitServiceSubmitEventForCitizen extends AbstractProbateSubmitServicePact{
    ...
    private static final String BASECASE_PAYLOAD_PATH = "json/SubmitEventCitizen.json";
    ...
    RequestResponsePact submitEventForCitizen(PactDslWithProvider builder) throws Exception {
        // @formatter:off
        return builder
                .given("A Submit Event for a Citizen is requested",setUpStateMapForProvider(EVENT_ID))
