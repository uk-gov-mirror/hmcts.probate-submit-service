...
import uk.gov.hmcts.probate.SubmitApplication;
import uk.gov.hmcts.probate.model.TokenExchangeResponse;
import uk.gov.hmcts.probate.services.IdamApi;
...
public class SidamExchangeCodeConsumerTest {
    ...
    @Pact(provider = "idamApi_authorization", consumer = "probate_submitService")
